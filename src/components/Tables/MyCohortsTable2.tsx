...
const MyCohortsTable2 = () => {
  ...
  const handleEyeClick = (cohort) => {
    ...
    router.push(`/client-dashboard/my-registration/courses-after-payment/proceed?cohort_id=${cohort.cohort_id}`);
  };
...
export default MyCohortsTable2;
