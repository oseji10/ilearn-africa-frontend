...
const IncompleteApplicationsTable = () => {
  ...
  const fetchIncompleteApplications = async () => {
    try {
      ...
      const response = await axios.get(
        `${process.env.NEXT_PUBLIC_API_URL}/incomplete_applications`,
        {
          headers: {
      ...
      setIncompleteApplications(response.data.incompleteApplications);
      setFilteredIncompleteApplications(response.data.incompleteApplications); // Set initial filtered courses
      setLoading(false);
    } catch (err) {
  ...
  const columns = [
    ...
    {
      name: "Client Name",
      selector: (row) => `${row?.firstname} ${row?.othernames} ${row?.surname}`,
      sortable: true,
    },
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
          ...
          >
            ...
            <div className="mb-4">
              ...
              {selectedIncompleteApplications.firstname} {selectedIncompleteApplications.othernames} {selectedIncompleteApplications.surname}
            </div>
            ...
            <div className="mb-4">
              ...
              {selectedIncompleteApplications.user?.email} 
            </div>
            ...
            <div className="mb-4">
              ...
              {selectedIncompleteApplications.user?.phone_number} 
            </div>
...
export default IncompleteApplicationsTable;
