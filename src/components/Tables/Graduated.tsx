  ...
  const currentlyAdmitted = async () => {
    try {
      ...
      const response = await axios.get(
        `${process.env.NEXT_PUBLIC_API_URL}/graduated`,
        {
          headers: {
      ...
      setIncompleteApplications(response.data.graduated);
      setFilteredIncompleteApplications(response.data.graduated); // Set initial filtered courses
      setLoading(false);
    } catch (err) {
