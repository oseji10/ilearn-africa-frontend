  ...
  const fetchIncompleteApplications = async () => {
    try {
      ...
      const response = await axios.get(
        `${process.env.NEXT_PUBLIC_API_URL}/registered_clients`,
        {
          headers: {
      ...
      setIncompleteApplications(response.data.registeredClients);
      setFilteredIncompleteApplications(response.data.registeredClients); // Set initial filtered courses
      setLoading(false);
    } catch (err) {
