...
import { faCircleCheck, faStop } from "@fortawesome/free-solid-svg-icons";
      ...
      <div className="mx-auto max-w-242.5">
        ...
        <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          ...
          <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
            ...
            <div className="mt-4">
              <h2 className="mb-1.5 text-2xl font-semibold text-black dark:text-white">
              <FontAwesomeIcon
                            icon={faStop}
              ...
              <p className="font-medium">This payment failed. Please try again</p>
